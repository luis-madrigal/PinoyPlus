                            ...
                            '<div class = "col-lg-2 col-md-2 col-sm-2 col-xs-2 no-padding-right">' +
                                '<div class = "red-rect-bg">' +
                                    '<div class = "event-date">' +
                                        '<span class = "date">%DATE%</span><br><span class = "month">%MONTH%</span>' +
                                    '</div>' +
                                '</div>' +
                            '</div>' +
...
var announcementTemplate = '<div class = "announcement">'+
                                '<div class = "row">'+
                                    '<div class = "col-lg-2">'+
...
var updateTemplate = '<div class = "update">'+
                        '<div class = "row">'+
                            '<div class = "col-lg-5">'+
...
function addEvent(date, month, title) {
    var replacements = {"%DATE%" : date, "%MONTH%": month, "%EVENT_TITLE%": title};
...
function addAnnouncement(title, description, datetime) {
    ...
    var replacements = {"%TITLE%": title, "%DESCRIPTION%": description, "%DATETIME%": datetime};
...
function addUpdate(title, date) {
    ...
    var replacements = {"%TITLE%": title, "%DATE%": date};
